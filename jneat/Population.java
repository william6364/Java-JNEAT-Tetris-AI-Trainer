...
public class Population extends Neat {
    ...
    public void print_to_file_by_species_plus_score(String xNameFile, ArrayList<ArrayList<Integer>> scores) {
        //
        // write to file genome in native format (for re-read)
        //
        IOseq xFile;
        ...
        for(int i = 0; i < scores.size(); i++) {
            xFile.IOseqWrite("Organism #" + i + ": " + scores.get(i).stream().map(Object::toString).collect(Collectors.joining(" ")));
        }
        xFile.IOseqCloseW();
